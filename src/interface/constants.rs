...
impl TryFrom<i32> for WebRTCConnectionMethod {
    type Error = String;
    ...
    fn try_from(value: i32) -> Result<Self, Self::Error> {
        match value {
            ...
            2 => Ok(Self::LocalSTA),
            3 => Ok(Self::Remote),
            _ => Err(format!("Unsupported WebRTCConnectionMethod value: {value}")),
        }
    }
}
...
pub fn data_channel_type() -> &'static BTreeMap<&'static str, &'static str> {
...
pub fn rtc_topic() -> &'static BTreeMap<&'static str, &'static str> {
    static MAP: OnceLock<BTreeMap<&'static str, &'static str>> = OnceLock::new();
    MAP.get_or_init(|| {
        BTreeMap::from([
...
pub fn sport_cmd() -> &'static BTreeMap<&'static str, i32> {
...
pub fn app_error_messages() -> &'static BTreeMap<&'static str, &'static str> {
    static MAP: OnceLock<BTreeMap<&'static str, &'static str>> = OnceLock::new();
    MAP.get_or_init(|| {
        BTreeMap::from([
...
pub fn audio_api() -> &'static BTreeMap<&'static str, i32> {
    static MAP: OnceLock<BTreeMap<&'static str, i32>> = OnceLock::new();
    MAP.get_or_init(|| {
        BTreeMap::from([
            ("GET_AUDIO_LIST", 1001),
